export default function BasketballProgramWebsite() {
  ...
  const rosterPlayers = [
    { id: "jeremyah-burt", number: 0, name: "Jeremyah Burt", details: "G • 6'1\" • Class of 2030" },
    { id: "landon-ouellette", number: 4, name: "Landon Ouellette", details: "G • 5'11\" • Class of 2028" },
    { id: "kalou-ruot", number: 5, name: "Kalou Ruot", details: "F • 6'8\" • Class of 2028" },
    { id: "player-6", number: 6, name: "Player Name", details: "Position • Class" },
    { id: "player-7", number: 7, name: "Player Name", details: "Position • Class" },
    { id: "player-8", number: 8, name: "Player Name", details: "Position • Class" },
    { id: "player-9", number: 9, name: "Player Name", details: "Position • Class" },
    { id: "brayden-james", number: 10, name: "Brayden James", details: "G • 6'4\" • Class of 2029" },
    { id: "abraham-vega", number: 11, name: "Abraham Vega", details: "G • 5'9\" • Class of 2029" },
    { id: "brooklyn-james", number: 12, name: "Brooklyn James", details: "G • 6'2\" • Class of 2029" },
    { id: "dom-soto", number: 23, name: "Dom Soto", details: "G • 5'9\" • Class of 2028" },
    { id: "mapak-majak-machar", number: 34, name: "Mapak Majak Machar", details: "C • 7'1\" • Class of 2029" },
  ];
